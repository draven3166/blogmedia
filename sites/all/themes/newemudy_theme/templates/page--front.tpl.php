...
<div id="page-wrapper">
  <div id="page" class="<?php print $classes; ?>">
    ...
    <header id="main-header" <?php print $header_attributes; ?>>
      <div class="header-containder">
        <!-- Menu movil-->
        <div class="header-menu">
          <?php
            if ($primary_navigation): print $primary_navigation; endif;
          ?>
        </div>
        <!-- Logo -->
        <div class="header-logo">
          <a href="<?php echo $base_path;?>">
            <img src="<?php echo $base_path;?>sites/default/files/new_logo.png" class="logo-header">
          </a>
        </div>
        <!-- Buscador -->
        ...
        <div class="date">
          <?php print format_date(time(), 'custom', 'l j \d\e F');?>
        </div>
      </div>
    </header>
    ...
    <footer<?php print $footer_attributes; ?>>
      <div class="container container-inside">
        <div class="menu-section-content">
          <?php // See custom/lostiempos/lostiemp
           print $footer_menu;
          ?>
        </div>
        ...
        <?php /*<iframe src="http://www.lostiemposdigital.net/" id="iframe-footer" style="border: medium none; clear: both;height: auto;width: 100%;"></iframe>
              */
        ?>
        <div class="credits-content">
          <div class="copy">Emudy - <?php print format_date(time(), 'custom', 'Y');?></div>
          <div class="author"><a href="<?php echo $base_path.'/node/16';?>">Condiciones de uso</a></div>
        </div>
