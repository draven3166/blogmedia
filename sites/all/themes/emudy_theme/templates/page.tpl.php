...
<?php if (!empty($page['main-menu'])): ?>
    <div class="main-header" id="js-header">
      <div class="ed-container">
        <div class="ed-item base-40 tablet-15 cross-center">
          <a href="<?php echo $base_path;?>">
            <img src="<?php echo $base_path;?>sites/default/files/new_logo.png" class="logo">
          </a>
        </div>
        <div class="ed-item base-60 tablet-25 web-30 cross-center">
          <?php print render($page['header_1']); ?>
        </div>
        <div class="ed-item base-85 tablet-50  web-45 tablet-main-end web-45">
          <?php //print render($page['main-menu']); ?>
        </div>
        <div class="ed-item base-15 tablet-10 web-10 main-end tablet-cross-center">
...
<!-- Pre Content: Region a todo lo ancho del viewport -->
    ...
    <div id="main">
        <div class="ed-container">
            ...
            <?php endif; ?>
            <?php if (!empty($page['sidebar_first']) && empty($page['sidebar_second']) ): ?>
                <div id="content" class="contenido caja web-70 sidebar-first">
            <?php endif; ?>
            <?php if (empty($page['sidebar_first']) && !empty($page['sidebar_second']) ): ?>
                <div id="content" class="contenido caja web-70 sidebar-second">
            <?php endif; ?>
                <a id="main-content"></a>
            ...
            <?php if (!empty($page['sidebar_first'])): ?>
                <aside id="sidebar_first" class="sidebar caja web-30">
                    <?php print render($page['sidebar_first']); ?>
                </aside>
            <?php endif; ?>

            <?php if (!empty($page['sidebar_second'])): ?>
                <aside id="sidebar_second" class="sidebar caja web-30">
