...
The module also provides hooks for other modules. You can also use Rules module to
react on user login and user creation events. You can easily extend Facebook
